...
public static class TestDTO implements GenericFilterDTO {
    @UISchema(
            ...
            minLength = 3,
            maxLength = 100,
            pattern = ValidationPattern.FULL_NAME,
            requiredMessage = "O nome é obrigatório",
            minLengthMessage = "O nome deve ter pelo menos 3 caracteres",
            maxLengthMessage = "O nome deve ter no máximo 100 caracteres",
            patternMessage = "Digite um nome válido",
            order = 1,
            group = "Dados Pessoais",
            icon = "person",
            helpText = "Informe seu nome conforme documento oficial"
    )
    private String nome;
