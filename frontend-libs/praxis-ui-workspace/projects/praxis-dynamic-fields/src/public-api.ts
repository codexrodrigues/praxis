...
export * from './lib/components/material-multi-select-tree/material-multi-select-tree.component';
...
export * from './lib/components/material-file-upload/material-file-upload.component';
