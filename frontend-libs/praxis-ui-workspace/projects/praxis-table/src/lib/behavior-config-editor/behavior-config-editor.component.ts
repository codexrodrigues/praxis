      ...
      <form [formGroup]="behaviorForm">
        ...
        <mat-expansion-panel expanded>
          ...
          <div class="config-section">
            <mat-slide-toggle formControlName="paginationEnabled" class="toggle-field">
              Habilitar paginação
            </mat-slide-toggle>
            
            <div class="config-fields" *ngIf="behaviorForm.get('paginationEnabled')?.value">
              <mat-form-field appearance="outline">
                <mat-label>Itens por página</mat-label>
                <input matInput type="number" formControlName="pageSize" min="1" max="100">
                <mat-hint>Número de registros exibidos por página</mat-hint>
              </mat-form-field>
              
              <mat-form-field appearance="outline">
                <mat-label>Opções de tamanho de página</mat-label>
                <input matInput formControlName="pageSizeOptions" placeholder="5, 10, 25, 50">
                <mat-hint>Valores separados por vírgula</mat-hint>
              </mat-form-field>
              
              <mat-slide-toggle formControlName="showFirstLastButtons" class="toggle-field">
              ...
              <mat-form-field appearance="outline" *ngIf="isV2">
                ...
                <mat-select formControlName="paginationStrategy">
                  ...
                  <mat-option value="server">Servidor (paginação remota)</mat-option>
                </mat-select>
              </mat-form-field>
            </div>
          </div>
        ...
        <mat-expansion-panel>
          ...
          <div class="config-section">
            <mat-slide-toggle formControlName="sortingEnabled" class="toggle-field">
              Habilitar ordenação
            </mat-slide-toggle>
            
            <div class="config-fields" *ngIf="behaviorForm.get('sortingEnabled')?.value && isV2">
              <mat-slide-toggle formControlName="multiSort" class="toggle-field">
                Ordenação múltipla
                <mat-icon class="info-icon" matTooltip="Permite ordenar por múltiplas colunas simultaneamente">
                  info_outline
                </mat-icon>
              </mat-slide-toggle>
              ...
              <mat-form-field appearance="outline">
                ...
                <mat-select formControlName="sortingStrategy">
                  <mat-option value="client">Cliente (ordenação local)</mat-option>
                  <mat-option value="server">Servidor (ordenação remota)</mat-option>
                </mat-select>
              </mat-form-field>
              
              <mat-slide-toggle formControlName="allowClearSort" class="toggle-field">
        ...
        <mat-expansion-panel>
          ...
          <div class="config-section">
            <mat-slide-toggle formControlName="filteringEnabled" class="toggle-field">
              Habilitar filtragem
            </mat-slide-toggle>
            
            <div class="config-fields" *ngIf="behaviorForm.get('filteringEnabled')?.value">
              <mat-slide-toggle formControlName="globalSearchEnabled" class="toggle-field">
                Busca global
                <mat-icon class="info-icon" matTooltip="Campo de busca que filtra todas as colunas">
                  info_outline
                </mat-icon>
              </mat-slide-toggle>
              
              <mat-form-field appearance="outline" *ngIf="behaviorForm.get('globalSearchEnabled')?.value">
                <mat-label>Placeholder da busca</mat-label>
                <input matInput formControlName="searchPlaceholder">
              </mat-form-field>
              
              <div *ngIf="isV2">
                <mat-slide-toggle formControlName="columnFiltersEnabled" class="toggle-field">
                  Filtros por coluna
                  <mat-icon class="info-icon" matTooltip="Adiciona filtros individuais em cada coluna">
                    info_outline
                  </mat-icon>
                </mat-slide-toggle>
                
                <mat-slide-toggle formControlName="advancedFiltersEnabled" class="toggle-field">
                  Filtros avançados
                  <mat-icon class="info-icon" matTooltip="Editor visual de queries complexas">
                    info_outline
                  </mat-icon>
                </mat-slide-toggle>
                ...
                <mat-form-field appearance="outline">
                  ...
                  <input matInput type="number" formControlName="filterDebounce" min="0" max="2000">
        ...
        <mat-expansion-panel>
          ...
          <div class="config-section">
            <mat-slide-toggle formControlName="selectionEnabled" class="toggle-field">
              Habilitar seleção
            </mat-slide-toggle>
            
            <div class="config-fields" *ngIf="behaviorForm.get('selectionEnabled')?.value">
              <mat-form-field appearance="outline">
        ...
        <mat-expansion-panel *ngIf="isV2">
          ...
          <div class="config-section">
            <div class="config-fields">
              <mat-slide-toggle formControlName="rowClickEnabled" class="toggle-field">
                Ação ao clicar na linha
              </mat-slide-toggle>
              
              <mat-form-field appearance="outline" *ngIf="behaviorForm.get('rowClickEnabled')?.value">
              ...
              <mat-slide-toggle formControlName="rowDoubleClickEnabled" class="toggle-field">
                Ação ao duplo clique
              </mat-slide-toggle>
              
              <mat-slide-toggle formControlName="hoverEnabled" class="toggle-field">
                Efeitos de hover
              </mat-slide-toggle>
              
              <mat-slide-toggle formControlName="keyboardEnabled" class="toggle-field">
                Navegação por teclado
                <mat-icon class="info-icon" matTooltip="Permite navegação com setas e atalhos">
                  info_outline
                </mat-icon>
              </mat-slide-toggle>
            </div>
...
export class BehaviorConfigEditorComponent implements OnInit, OnDestroy {
  ...
  private initializeForm(): void {
    ...
    this.behaviorForm = this.fb.group({
      ...
      pageSizeOptions: [this.arrayToString(pagination.pageSizeOptions || [5, 10, 25, 50])],
    ...
    if (this.isV2) {
      ...
      if (behavior.filtering) {
        this.behaviorForm.patchValue({
          ...
          globalSearchEnabled: behavior.filtering.globalFilter?.enabled !== false,
          searchPlaceholder: behavior.filtering.globalFilter?.placeholder || 'Buscar...',
          columnFiltersEnabled: behavior.filtering.columnFilters?.enabled || false,
          advancedFiltersEnabled: behavior.filtering.advancedFilters?.enabled || false,
      ...
      if (behavior.interaction) {
        this.behaviorForm.patchValue({
          ...
          rowDoubleClickEnabled: behavior.interaction.rowDoubleClick?.enabled || false,
