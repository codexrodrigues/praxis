    ...
    <form [formGroup]="validatorForm" class="conditional-validator-form">
      ...
      <div class="form-row" *ngIf="validatorType">
        <mat-form-field appearance="outline" class="target-field-select">
          ...
          <mat-select formControlName="targetField" 
                     (selectionChange)="onTargetFieldChanged($event.value)">
      ...
      <div class="form-section" *ngIf="validatorType && targetField">
        ...
        <div class="condition-mode-selector">
          <mat-button-toggle-group formControlName="conditionMode" 
                                  (change)="onConditionModeChanged($event.value)">
          ...
          <div class="logic-builder">
            <mat-form-field appearance="outline" class="logic-operator">
              ...
              <mat-select formControlName="logicOperator">
                ...
                <mat-option value="not">NOT - Condition must be false</mat-option>
                <mat-option value="xor">XOR - Only one condition can be true</mat-option>
              </mat-select>
            </mat-form-field>

            <div class="conditions-list">
              <div *ngFor="let condition of advancedConditions; let i = index; trackBy: trackByIndex"
      ...
      <div class="form-section" *ngIf="validatorType && validatorType !== 'requiredIf'">
        <h4 class="section-title">
          <mat-icon>visibility</mat-icon>
          UI Behavior Settings
        </h4>
        ...
        <div class="ui-settings">
          <div *ngIf="validatorType === 'visibleIf'" class="visibility-settings">
          ...
          <div *ngIf="validatorType === 'disabledIf'" class="disabled-settings">
            ...
            <mat-form-field *ngIf="showDisabledMessage" appearance="outline" class="disabled-message-input">
...
export class ConditionalValidatorEditorComponent implements OnInit, OnChanges {
  ...
  private loadInitialConfig(): void {
    ...
    this.conditionMode = this.config.conditions && this.config.conditions.length > 1 ? 'advanced' : 'simple';
  ...
  private emitConfigChange(): void {
    ...
    const config: ConditionalValidatorConfig = {
      ...
      conditions: this.conditionMode === 'simple' 
  ...
  getPreviewText(): string {
    ...
    const conditionText = this.conditionMode === 'simple' 
  ...
  onTargetFieldChanged(fieldName: string): void {
    this.targetField = fieldName;
  }

  onConditionModeChanged(mode: string): void {
